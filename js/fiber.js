...
function buildCablePanel(c){
  ...
  if(c.grupos>1){
    ...
    div.style.cssText='width:90px;display:flex;flex-direction:'+(isE?'row':'row-reverse')+';min-height:'+totalH+'px;border-radius:8px;overflow:hidden;';
    div.appendChild(buildLbar());
    var bdy2=document.createElement('div');
    bdy2.style.cssText='width:70px;flex-shrink:0;position:relative;background:#f8fafc;';
    var tb2=document.createElement('div');
    tb2.style.cssText='position:absolute;top:0;bottom:0;width:8px;background:#808080;border:1px solid #555;z-index:0;'+(isE?'left:3px':'right:3px');
    ...
    for(var g=0;g<c.grupos;g++){
      ...
      for(var f2=0;f2<c.fpg;f2++){
        ...
        row2.style.cssText='display:flex;align-items:center;height:'+FH+'px;position:relative;z-index:1;gap:1px;padding:0 2px;'+(isE?'justify-content:flex-end;':'justify-content:flex-start;');
  ...
  // ── Tubo único (1 grupo) — visual ultra compacto, coluna fina ────
  var FH=24;
  var panelH=c.fpg*FH+12;
  div.className='panel cv-panel';
  div.style.cssText='width:90px;display:flex;flex-direction:'+(isE?'row':'row-reverse')+';min-height:'+panelH+'px;border-radius:8px;overflow:hidden;';
  div.appendChild(buildLbar());
  var bdy=document.createElement('div');
  bdy.style.cssText='width:70px;flex-shrink:0;position:relative;background:#f8fafc;';
  var tb=document.createElement('div');
  tb.style.cssText='position:absolute;top:0;bottom:0;width:8px;background:#808080;border:1px solid #555;z-index:0;'+(isE?'left:3px':'right:3px');
  bdy.appendChild(tb);
  for(var f=0;f<c.fpg;f++){
    var fi=f,fc=ABNT[f%12];
    var row=document.createElement('div');
    row.style.cssText='display:flex;align-items:center;height:'+FH+'px;position:relative;z-index:1;gap:1px;padding:0 2px;'+(isE?'justify-content:flex-end;':'justify-content:flex-start;');
