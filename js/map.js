...
function buildPosteIcon(p){
  ...
  return L.divIcon({
    ...
    html: `<div style="position:relative;width:32px;height:32px;filter:drop-shadow(0 0 1.5px #fff) drop-shadow(0 0 1.5px #fff) drop-shadow(0 1px 2px rgba(0,0,0,.5))">${badgesHtml}<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32" shape-rendering="geometricPrecision"><path fill="#000000" stroke="#000000" stroke-width="1.5" stroke-linejoin="round" d="m7 2l3 7h4l3-7zm6 18h3v2H8v-2h3V10h2z"/></svg></div>`,
    iconSize: [32, 32],
    iconAnchor: [16, 16],
    popupAnchor: [0, -32]
  });
...
function buildElemTooltipHTML(d){
  ...
  if(d.tipo==='poste'){
    ...
    childOlts.forEach(o=>{
      items+=`<div class="et-row" style="border-left-color:#06B6D4"><span class="et-dot" style="background:#06B6D4"></span><span class="et-lbl" style="color:#06B6D4">OLT</span><span class="et-vl">${o.nome||o.id}</span><span class="et-mt">${o.portas||16} PON</span></div>`;
    });
