...
function buildPosteIcon(p){
  ...
  return L.divIcon({
    ...
    html: `<div style="position:relative;width:28px;height:28px">${badgesHtml}<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="28" height="28" shape-rendering="geometricPrecision"><path fill="#000000" stroke="#000000" stroke-width="0.8" stroke-linejoin="round" d="m7 2l3 7h4l3-7zm6 18h3v2H8v-2h3V10h2z"/></svg></div>`,
    iconSize: [28, 28],
    iconAnchor: [14, 14],
    popupAnchor: [0, -28]
  });
...
const armarioIcon = L.divIcon({
  ...
  html: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="28" height="28" shape-rendering="geometricPrecision"><g fill="none" stroke="#000000" stroke-width="6"><path stroke-linejoin="round" d="M42 4H6v10h36zm0 15H6v10h36zm0 15H6v10h36z"/><path stroke-linecap="round" d="M21 9h6m-6 15h6m-6 15h6"/></g></svg>`,
  iconSize: [28, 28],
  iconAnchor: [14, 14],
  popupAnchor: [0, -14]
});
...
function initMap(){
  ...
  clusterPostes = L.markerClusterGroup({ 
  maxClusterRadius: 50,
  disableClusteringAtZoom: 19   // ← Desativa cluster no zoom 19
});
  clusterArmarios = L.markerClusterGroup({ 
  maxClusterRadius: 50,
  disableClusteringAtZoom: 19   // ← Idem
});
