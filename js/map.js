...
// Conta postes (incluindo este) dentro de tolM metros — usado pra mostrar badge ×N
// quando KMLs importados trazem múltiplos postes praticamente sobrepostos.
function getPosteOverlapCount(p, tolM){
